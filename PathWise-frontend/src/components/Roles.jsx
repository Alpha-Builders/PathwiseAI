    ...
    <div className="min-h-screen bg-paper py-12 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-ink-soft max-w-3xl mx-auto leading-relaxed">
        ...
        {roles.length === 0 ? (
          <div className="max-w-3xl mx-auto bg-card backdrop-blur-xl rounded-3xl shadow-xl border border-red-300 p-8 text-center mb-12">
            ...
            {roles.map((role) => {
              ...
              return (
                <div
                  ...
                  className="group bg-card backdrop-blur-xl rounded-3xl shadow-xl border border-green-100 p-8 cursor-pointer hover:shadow-2xl hover:scale-102 transition-all duration-300 hover:bg-card"
                >
                  {/* Header */}
                  <div className="flex items-start justify-between mb-6">
                    <div className="flex items-center gap-4">
                      <div className="w-14 h-1 bg-green-500 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                        <IconComponent className="w-7 h-7 text-ink" />
                      </div>
                      <div>
                        <h3 className="text-xl font-bold text-ink mb-1">{role.name}</h3>
                  ...
                  {/* Key Skills */}
                  <div>
                    <p className="text-xs text-ink-soft font-medium mb-3">KEY SKILLS REQUIRED</p>
