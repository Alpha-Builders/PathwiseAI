  ...
  if (currentPage === 'fieldSelection') {
    return (
     <div className="min-h-screen bg-gradient-to-br from-paper via-paper-soft to-paper text-ink relative overflow-hidden">
      ...
      {/* Header */}
      <div className="relative z-10 backdrop-blur-sm bg-card border-b border-card-line">
        <div className="flex justify-between items-center px-8 py-5">
          <span className="font-display text-2xl font-semibold text-ink">
            Pathwise <span className="text-forest">AI</span>
          </span>
          <div className="flex gap-6 items-center">
            <button className="relative p-2 hover:bg-card rounded-full transition-all duration-300">
              <Bell className="w-6 h-6 text-ink-soft hover:text-green-400 transition-colors" />
              <span className="absolute top-1 right-1 w-2 h-2 bg-green-500 rounded-full"></span>
            </button>
            <button className="p-2 hover:bg-card rounded-full transition-all duration-300">
              <User className="w-6 h-6 text-ink-soft hover:text-green-400 transition-colors" />
            </button>
          </div>
        </div>
       </div>
          ...
          <div className="mt-20 mb-10">
            <h4 className="text-center text-ink text-lg font-semibold mb-6">Popular Fields</h4>
        ...
        <div className="pt-10 px-10">
          <div className="flex justify-between items-center mb-12">
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-red-600 hover:bg-red-700 rounded-full transition-all duration-200 text-ink font-medium"
            >
              <X className="w-4 h-4" />
              Cancel
            </button>
            ...
            <div className="bg-green-600 rounded-2xl p-8 shadow-2xl">
              <div className="mb-6">
                <div className="flex justify-between items-center mb-4">
                  ...
                  <span className="text-sm font-medium text-ink bg-card px-4 py-1 rounded-full">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-green-600 rounded-2xl p-8 shadow-2xl">
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        <div className="flex items-center gap-3 mb-3">
                          <span className="flex items-center justify-center w-10 h-10 bg-gradient-to-r from-green-500 to-green-600 text-ink font-bold rounded-full text-xl">
                            {index + 1}
                          </span>
              ...
              <div className="flex justify-center">
                <button
                  onClick={resetQuiz}
                  className="bg-paper hover:bg-paper-soft hover:scale-105 text-ink font-semibold py-4 px-10 rounded-full transition-all duration-200 flex items-center gap-3"
                >
                  Take Quiz Again
