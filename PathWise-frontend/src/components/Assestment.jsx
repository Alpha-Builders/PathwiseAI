  ...
  return (
    <div className="min-h-screen bg-paper py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        {/* Assessment Card */}
        <div className="bg-card backdrop-blur-xl rounded-3xl shadow-2xl border border-green-100 p-8 md:p-12 mb-8">
          {/* Skill Badge */}
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button
              ...
              className="border-gray-200 text-ink-soft cursor-pointer hover:text-black hover:bg-green-50 px-8 py-3 rounded-2xl"
            >
              ← Back to Skills
            </button>
            ...
            <button
              ...
              size="lg"
              className="bg-green-500 flex cursor-pointer hover:from-green-700 hover:to-indigo-700 text-ink px-15 py-4 text-lg font-semibold rounded-2xl shadow-xl transform hover:scale-105 transition-all duration-300"
            >
              Start Assessment
